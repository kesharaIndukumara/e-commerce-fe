        ...
        <div  className='shadow-lg rounded-lg overflow-hidden '>
            ...
            <Link href={`/products/${product.id}`}>
                <div className="relative aspect-[2/3]">
                    <Image src={product.images[productTypes.color]} alt={product.name} fill className="object-cover hover:scal-105 transition-all duration-300" />
                </div>
            </Link>
            {/*PRODUCT_DETAILS*/}
            <div className="flex flex-col gap-4 p-4">
                ...
                <div className="flex items-center gap-4 text-xs">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <select className="ring ring-gray-300 rounded-md px-2 py-1" name="size" id="size"
                        onChange={e=>
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-2">
                            {product.colors.map(color => (
                                <div className={`cursor-pointer border-1 rounded-full p-[1.2px] ${productTypes.color === color ? "border-gray-400" : "border-gray-200"}`} key={color}
